  ...
  it('loads the exact six topic profile contracts', async () => {
    ...
    expect(compact).toEqual([
      { id: 'ai-agents', topicLabel: 'AI Agents', menuLabel: 'AI Agents', sourceTiers: {
        tier1: [['AIAgentStore', 'aiagentstore.ai'], ['OpenAI', 'openai.com'], ['Anthropic', 'anthropic.com'], ['TechCrunch AI', 'techcrunch.com'], ['VentureBeat AI', 'venturebeat.com'], ['Google DeepMind', 'deepmind.google'], ['Microsoft Azure AI', 'azure.microsoft.com'], ['AWS AI and ML', 'aws.amazon.com'], ['NVIDIA Developer', 'developer.nvidia.com'], ['LangChain Blog', 'langchain.com'], ['LlamaIndex', 'llamaindex.ai'], ['CrewAI', 'crewai.com'], ['Agentic AI Foundation', 'aaif.io'], ['METR', 'metr.org'], ['SWE-bench', 'swebench.com'], ['OpenHands', 'openhands.dev'], ['Mem0', 'mem0.ai']],
      ...
      { id: 'ai-glasses', topicLabel: 'AI Glasses', menuLabel: 'AI Glasses', sourceTiers: {
        tier1: [['Meta', 'meta.com'], ['Google', 'google.com'], ['Snap', 'snap.com'], ['XREAL', 'xreal.com'], ['Brilliant Labs', 'brilliant.xyz'], ['Viture', 'viture.com'], ['RayNeo', 'rayneo.com'], ['UploadVR', 'uploadvr.com'], ['RoadToVR', 'roadtovr.com'], ['Apple', 'apple.com'], ['Qualcomm', 'qualcomm.com'], ['Magic Leap', 'magicleap.com'], ['Rokid', 'rokid.com'], ['Even Realities', 'evenrealities.com'], ['Vuzix', 'vuzix.com'], ['RealWear', 'realwear.com'], ['Solos', 'solosglasses.com'], ['Mentra', 'mentraglass.com'], ['Envision', 'letsenvision.com'], ['XRAI Glass', 'xrai.glass'], ['Lumus', 'lumus.com'], ['DigiLens', 'diglens.com']], tier2: [['MIXED Reality News', 'mixed-news.com'], ['XR Today', 'xrtoday.com'], ['The Verge', 'theverge.com'], ['Android Central', 'androidcentral.com']], tier3: [],
      ...
      { id: 'openai-api', topicLabel: 'OpenAI API', menuLabel: 'OpenAI API', sourceTiers: {
        tier1: [['OpenAI', 'openai.com'], ['Azure AI', 'azure.microsoft.com'], ['LangChain', 'langchain.com'], ['LlamaIndex', 'llamaindex.ai'], ['OpenRouter', 'openrouter.ai'], ['Vercel AI SDK', 'sdk.vercel.ai'], ['Cloudflare Developer Platform', 'blog.cloudflare.com'], ['Portkey', 'portkey.ai'], ['Helicone', 'helicone.ai'], ['LiteLLM', 'litellm.ai'], ['Instructor', 'python.useinstructor.com'], ['Pydantic AI', 'pydantic.dev'], ['OpenAI Agents SDK Docs', 'openai.github.io'], ['Langfuse', 'langfuse.com'], ['Promptfoo', 'promptfoo.dev']], tier2: [['Hugging Face', 'huggingface.co'], ['Simon Willison', 'simonwillison.net'], ['The New Stack', 'thenewstack.io'], ['InfoQ', 'infoq.com'], ['Artificial Analysis', 'artificialanalysis.ai']], tier3: [],
      ...
      { id: 'ai-blockchain', topicLabel: 'AI x Blockchain', menuLabel: 'AI x Blockchain', sourceTiers: {
        tier1: [['CoinDesk', 'coindesk.com'], ['The Block', 'theblock.co'], ['Bankless', 'bankless.com'], ['Paradigm', 'paradigm.xyz'], ['a16z crypto', 'a16zcrypto.com'], ['Sui', 'sui.io'], ['Base', 'base.org'], ['Ethereum Foundation', 'ethereum.org'], ['Chainlink', 'chain.link'], ['Solana', 'solana.com'], ['NEAR', 'near.ai'], ['Olas', 'olas.network'], ['Fetch.ai', 'fetch.ai'], ['Virtuals Protocol', 'virtuals.io'], ['Ritual', 'ritual.net'], ['Gensyn', 'gensyn.ai'], ['io.net', 'io.net'], ['Akash Network', 'akash.network'], ['Sentient', 'sentient.xyz']], tier2: [['Messari', 'messari.io'], ['Blockworks', 'blockworks.com'], ['DL News', 'dlnews.com'], ['Chain of Thought', 'chainofthought.xyz'], ['Delphi Digital', 'delphidigital.io']], tier3: [['Decrypt', 'decrypt.co']],
      ...
      { id: 'ai-travel', topicLabel: 'AI Travel', menuLabel: 'AI Travel', sourceTiers: {
        tier1: [['Skift', 'skift.com'], ['PhocusWire', 'phocuswire.com'], ['Google Travel', 'travel.google.com'], ['Booking', 'booking.com'], ['Airbnb', 'airbnb.com'], ['Amadeus', 'amadeus.com'], ['Expedia Group', 'expediagroup.com'], ['Trip.com', 'trip.com'], ['Hopper', 'hopper.com'], ['Sabre', 'sabre.com'], ['TravelPerk', 'travelperk.com'], ['Tripadvisor', 'tripadvisor.com'], ['Travelport', 'travelport.com'], ['Cloudbeds', 'cloudbeds.com'], ['Canary Technologies', 'canarytechnologies.com'], ['Mews', 'mews.com']], tier2: [['Web in Travel', 'webintravel.com'], ['Travel Weekly', 'travelweekly.com'], ['Travolution', 'travolution.com'], ['McKinsey Travel', 'mckinsey.com'], ['TNMT', 'tnmt.com'], ['Hospitality Technology', 'hospitalitytechnology.com']], tier3: [],
